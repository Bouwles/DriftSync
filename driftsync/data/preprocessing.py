"""Engineer per-session behavioural features and future-error labels.

The 15 model inputs are listed in data.dataset.FEATURE_COLS. A positive
label means at least one error occurs in the next K trials.
"""
